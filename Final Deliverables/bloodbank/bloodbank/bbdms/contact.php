              ...
              <div class="col-lg-8 mb-4">
                ...
                <form name="sentMessage"  method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Message:</label>
                            <textarea rows="10" cols="100" class="form-control" id="message" name="message" required data-validation-required-message="Please enter your message.We will clear soon" maxlength="999" style="resize:none"></textarea>
                        </div>
                    </div>
                    <div id="success"></div>
...
{ ?>
            <div class="col-lg-4 mb-4">
                ...
                <p>
                    <abbr title="Email">E</abbr>: <a href="mailto:girisadhasivam@gmail.com"><?php   echo htmlentities($result->EmailId); ?>
                    </a>
                </p>
              <?php }} ?>
            </div>
